...
// class declaration
//
class ZNtupleMaker_2l2q : public edm::EDAnalyzer {
public:
  explicit ZNtupleMaker_2l2q(const edm::ParameterSet&);
  ~ZNtupleMaker_2l2q();
...
/*
//double event omitter//added by Aloke, dis-activated by Clara
...
//
ZNtupleMaker_2l2q::ZNtupleMaker_2l2q(const edm::ParameterSet& pset) :
  myHelper(pset),
...
ZNtupleMaker_2l2q::~ZNtupleMaker_2l2q()
{
...
void ZNtupleMaker_2l2q::analyze(const edm::Event& event, const edm::EventSetup& eSetup)
{
...
*/
  ...
  int nFilled = 0;
  bool double_event=false;
  cout<<"print cand size = "<<cands->size()<<endl;
  ...
  //  if(!((bool)(cand->userFloat("isBestZ")))) continue;
    if(!((bool)(cand->userFloat("isBestZ"))) || double_event) continue;
...
void ZNtupleMaker_2l2q::FillCandidate(const pat::CompositeCandidate& cand, bool evtPass, const edm::Event& event)
{
...
void ZNtupleMaker_2l2q::FillJet(const pat::Jet& jet)
{
...
void ZNtupleMaker_2l2q::FillPhoton(int year, const pat::Photon& photon)
{
...
void ZNtupleMaker_2l2q::beginJob()
{
...
void ZNtupleMaker_2l2q::beginRun(edm::Run const&, edm::EventSetup const&)
{
}

// ------------ method called when ending the processing of a run  ------------
void ZNtupleMaker_2l2q::endRun(edm::Run const&, edm::EventSetup const&)
{
}

// ------------ method called when starting to processes a luminosity block  ------------
void ZNtupleMaker_2l2q::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
  Nevt_Gen_lumiBlock = 0;
}

// ------------ method called when ending the processing of a luminosity block  ------------
void ZNtupleMaker_2l2q::endLuminosityBlock(edm::LuminosityBlock const& iLumi, edm::EventSetup const& iSetup)
{
...
void ZNtupleMaker_2l2q::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
Float_t ZNtupleMaker_2l2q::getAllWeight(const reco::Candidate* Lep)
{
...
void ZNtupleMaker_2l2q::BookAllBranches(){
...
DEFINE_FWK_MODULE(ZNtupleMaker_2l2q);
