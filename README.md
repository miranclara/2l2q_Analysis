...
```
wget -O ${TMPDIR}/checkout_10X.csh https://raw.githubusercontent.com/miranclara/2l2q_Analysis/workig_branch_Rereco/checkout_10X.csh
cd $CMSSW_BASE/src
cmsenv
...
git push origin workig_branch_Rereco
```
