...
class ZZ2l2qAnalyzerCR: public edm::EDAnalyzer {
public:

  explicit ZZ2l2qAnalyzerCR(const edm::ParameterSet& pset);
  ~ZZ2l2qAnalyzerCR();
...
// Constructor
ZZ2l2qAnalyzerCR::ZZ2l2qAnalyzerCR(const ParameterSet& pset) :
  myHelper(pset),
...
//   if (theChannel!=18) {
//     cout << "ERROR: ZZ2l2qAnalyzerCR: channel "<< theChannel << " is not valid" <<endl;
//     abort();
//   }
...
ZZ2l2qAnalyzerCR::~ZZ2l2qAnalyzerCR()
{
  delete pileUpReweight;
}


void ZZ2l2qAnalyzerCR::beginJob(){
  // Book histograms
...
void ZZ2l2qAnalyzerCR::endJob(){
   
}


void ZZ2l2qAnalyzerCR::analyze(const Event & event, const EventSetup& eventSetup){
...
DEFINE_FWK_MODULE(ZZ2l2qAnalyzerCR);
